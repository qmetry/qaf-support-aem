...
import com.qmetry.qaf.automation.ui.aem.coral.CoralLocators.Repository;
...
public interface PageLocators {
	...
	public interface EditorPageLocators {
		...
		EPageRepository ePageRepository = new EPageRepository();

		static class EPageRepository {
	...
	static class PageRepository {
		...
		PageRepository() {
			...
			setDefault(CreatePageFormLocators.NAME_LOC_KEY, "{\"locator\":\"name=pageName\",\"desc\":\"Name field\"}");
